...
import { SendPublicInputsBorshLegacy } from './SendPublicInputsBorshLegacy.js';
 ...
 */
export class InitVerificationInstructionBorshLegacy {
    ...
    @field({ type: SendPublicInputsBorshLegacy })
        request!: SendPublicInputsBorshLegacy;
